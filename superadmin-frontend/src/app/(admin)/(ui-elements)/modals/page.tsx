...
export const metadata: Metadata = {
  title: "Next.js Modals | davcreations - Next.js Dashboard Template",
  description:
    "This is Next.js Modals page for davcreations - Next.js Tailwind CSS Admin Dashboard Template",
  // other metadata
};
