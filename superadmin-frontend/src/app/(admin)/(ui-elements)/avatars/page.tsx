...
export const metadata: Metadata = {
  title: "Next.js Avatars | davcreations - Next.js Dashboard Template",
  description:
    "This is Next.js Avatars page for davcreations - Next.js Tailwind CSS Admin Dashboard Template",
};
