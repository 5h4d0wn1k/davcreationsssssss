...
export const metadata: Metadata = {
  title: "Next.js Buttons | davcreations - Next.js Dashboard Template",
  description:
    "This is Next.js Buttons page for davcreations - Next.js Tailwind CSS Admin Dashboard Template",
};
